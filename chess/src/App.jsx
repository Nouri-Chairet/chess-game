...
for (let i=0;i<8;i++)
{
    pawns.push(new Piece('white', i, 1,  w_pawn, 'pawn'));
}
const white = [
    ...pawns,
    new Piece('white', 2, 0,  w_bishop, 'bishop'),
    new Piece('white', 5, 0,  w_bishop, 'bishop'),
    new Piece('white', 0, 0,  w_rock, 'rock'),
    new Piece('white', 7, 0,  w_rock, 'rock'),
    new Piece('white', 1, 0,  w_knight, 'knight'),
    new Piece('white', 6, 0, w_knight, 'knight'),
    new Piece('white', 4, 0,  w_king, 'king'),
    new Piece('white', 3, 0,  w_queen, 'queen'),
];
let pawns_b =[];
for (let i=0;i<8;i++)
{
    pawns_b.push(new Piece('black', i, 6, b_pawn, 'pawn'));
}
const black = [
    ...pawns_b,
    new Piece('black', 2, 7, b_bishop, 'bishop'),
    new Piece('black', 5, 7, b_bishop, 'bishop'),
    new Piece('black', 0, 7, b_rock, 'rock'),
    new Piece('black', 7, 7, b_rock, 'rock'),
    new Piece('black', 1, 7, b_knight, 'knight'),
    new Piece('black', 6, 7, b_knight, 'knight'),
    new Piece('black', 4, 7, b_king, 'king'),
    new Piece('black', 3, 7, b_queen, 'queen'),
];
class Player {
