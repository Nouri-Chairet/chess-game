...
const Table = React.memo(({ board, setBoard, Player1, Player2, setPlayer1, setPlayer2, MovesHistory, setMovesHistory, currentPlayer, setCurrentPlayer, setGameOver, mode ,me="white",socket="",id="",gameId=""}) => {
        ...
        if (mode==="online" ) {
                if(me!==currentPlayer.color){
                        socket.on("recieveMove", (data) => {
                                ...
                                try{
                                        makeAMove(destinationSquareY, destinationSquareX, board[sourceSquareX][sourceSquareY], board, setCurrentPlayer, setGameOver, setPossibleMoves, setBoard, setMovesHistory, currentPlayer, MovesHistory, setPlayer1, setPlayer2, setFullMove, Player1, Player2, id, gameId, socket, mode, me)();
                                }
                                catch(error){
                                                                                                ...
                                                                                                <div
                                                                                                                ...
                                                                                                                onClick={() => {
                                                                                                                                ...
                                                                                                                                if (isPossibleMove([i, j])) {
                                                                                                                                                makeAMove(i, j, selectedPiece, board, setCurrentPlayer, setGameOver, setPossibleMoves, setBoard, setMovesHistory, currentPlayer, MovesHistory, setPlayer1, setPlayer2, setFullMove, Player1, Player2 ,id,gameId,socket,mode,me)();
                                                                                                                                } else {
                                                                                                                                                suggest(element);
                                                                                                                                }
                                                                                                                }}
